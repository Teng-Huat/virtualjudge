defmodule URIOJ.Scraper do
  alias VirtualJudge.Problem
  alias VirtualJudge.Repo

  @doc """
  Scrapes URIOJ `url` for the specific problem, saves it to the database
  ...
  def perform(url, topic) do
    ...
    {title, description, language, source} = URIOJ.scrape_problem(url_path)
