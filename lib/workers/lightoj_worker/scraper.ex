defmodule LightOJ.Scraper do
  alias VirtualJudge.Problem
  alias VirtualJudge.Repo

  @doc """
  Scrapes LightOJ `url` for the specific problem, saves it to the database
  ...
  def perform(url, topic) do
    ...
    {title, description, language, source} = LightOJ.scrape_problem(url_path)
